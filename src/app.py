...
activities = {
    ...
    "Soccer Club": {
        "description": "Practice and compete in friendly soccer matches",
    ...
    "Drama Club": {
        "description": "Rehearse and perform stage plays and improv scenes",
        "schedule": "Tuesdays and Thursdays, 4:00 PM - 5:30 PM",
        "max_participants": 20,
    ...
    "Debate Team": {
        ...
        "max_participants": 18,
        "participants": ["jack@mergington.edu", "olivia2@mergington.edu"]
    }
}
